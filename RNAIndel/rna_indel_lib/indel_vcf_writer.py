...
def indel_vcf_writer(df, df_filtered, bam, fasta, chr_prefixed, vcfname):
    ...
    vcf = partial(generate_indel_vcf, info_dict=info, format_dict=fmt, fa=fa, chr_prefixed=chr_prefixed)
...
def generate_indel_vcf(row, info_dict, format_dict, fa, chr_prefixed):
    ...
    Args:
        ...
        chr_prefixed (bool): True if chromosome names are "chr"-prefixed
    """
    idl_vcf = IndelVcfReport(fa, row["chr"], row["pos"], row["ref"], row["alt"], chr_prefixed)
