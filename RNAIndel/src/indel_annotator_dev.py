...
def indel_annotator(row, exon_data, fasta):
    ...
    idls = coding_indel_generator(chr, pos, idl_type, idl_seq, exon_data, fasta)
...
def coding_indel_generator(chr, pos, idl_type, idl_seq, exon_data, fasta):
    """Generates coding indel instances
    ...
    if candidate_genes:
        for line in candidate_genes:
            ...
            and idl_type == 0 and exon_start > pos:
                ...
                ic.curate_indel_in_genome(fasta, chr, pos, idl_type, idl_seq)
